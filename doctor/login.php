...
function login(){
    if(isset($_POST['login'])){
        ...
        $query= "SELECT * FROM doctors WHERE BINARY docID='$docid' && docPw='$docpw'";
...
<!-- Required meta tags -->
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Doctor Panel - Login</title>
	<!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container" >
		...
		<div class="card-header text-center" style="border-radius: 20px;"><a class="navbar-brand" href="login.php">Doctor Panel</a><span class="splash-description">Login to doctor panel.</span></div>
			<div class="card-body">
            
                <form id="loginform" action="" method="POST">
                    <div id="login_div">
                        <div class="form-group">
                            <input class="form-control form-control-lg"  type="text" name="id" required="required" placeholder="Doctor ID" autocomplete="off">
                        </div>
                        <div class="form-group">
