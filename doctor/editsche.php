...
<head>
    ...
    <title>Doctor Panel - Edit Schedule</title>
    <!-- Bootstrap CSS -->
					...
					<div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Edit Schedule</h2>
                                    ...
                                    <form id="form" action="" method="POST">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="edit_deptid" type="text" name="edit_schedid" value="<?php echo $row['sched_id']?>" class="form-control" readonly>
                                            </div>
                                        </div>
										<div class="form-group row">
                                            <label for="inputPassword" class="col-3 col-lg-2 col-form-label text-right">Schedule Time: </label>
                                            <div class="col-9 col-lg-10">
                                                <input id="edit_deptName" type="text" name="edit_datetime" value="<?php echo $row['sched_datetime']?>" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-3 col-lg-2 col-form-label text-right">Department Name: </label>
                                            <div class="col-9 col-lg-10">
                                                <input id="edit_deptName" type="text" name="edit_status" value="Booked" class="form-control">
                                            </div>
                                        </div>
                                        <?php
                                                    }
                                    ...
                                    ?>
                                        ...
                                        <div class="row pt-2 pt-sm-5 mt-1">
                                            ...
                                            <div class="col-sm-6 pl-0">
                                                <p class="text-right">
                                                    <a href="scheFunc.php" class="btn btn-space btn-danger" style="border-radius: 5px;">Cancel</a>
